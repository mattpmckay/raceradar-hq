  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-gray-400">Here&apos;s your motorsport overview.</p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        {[
          ...
          { icon: Trophy, label: 'Championships', value: '—', href: '/championships' },
      ...
      <div className="card">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Link href="/tracks" className="btn-secondary text-sm">Explore Tracks</Link>
          <Link href="/championships" className="btn-secondary text-sm">Championships</Link>
        </div>
      </div>
    </div>
  )
