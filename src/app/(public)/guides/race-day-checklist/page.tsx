    ...
    <div className="container-page py-10">
      ...
      <div className="mb-10 max-w-2xl">
        <div className="flex items-center gap-3 mb-4">
          <span className="text-xs font-semibold uppercase tracking-widest text-gray-500">Race Day</span>
      ...
      <div className="max-w-2xl space-y-10">
        ...
        <section>
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            ...
            <div className="card space-y-3">
              <h3 className="text-sm font-semibold text-white">Core Race Kit</h3>
              <ul className="space-y-2">
                {[
                  ...
                  <li key={item} className="flex items-start gap-2 text-xs text-gray-400">
                    <span className="h-1 w-1 rounded-full bg-brand-500/60 mt-1.5 shrink-0" />
                    {item}
                  </li>
                ))}
              </ul>
            ...
            <div className="card space-y-3">
              <h3 className="text-sm font-semibold text-white">Nutrition & Hydration</h3>
              <ul className="space-y-2">
                {[
            ...
            <div className="card space-y-3">
              <h3 className="text-sm font-semibold text-white">Recovery & Comfort</h3>
              <ul className="space-y-2">
                {[
            ...
            <div className="card space-y-3">
              <h3 className="text-sm font-semibold text-white">Admin & Extras</h3>
              <ul className="space-y-2">
                {[
        ...
        <section>
          ...
          <ul className="space-y-3">
            {[
              ...
              <li key={time} className="rounded-xl border border-surface-border bg-surface-card p-4 text-sm">
                <div className="font-semibold text-white mb-1">{time}</div>
        ...
        <div className="rounded-2xl border border-surface-border bg-surface-card p-8 text-center">
          <h2 className="text-lg font-bold text-white">Ready to find your next race?</h2>
